...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      {/* Header */}
      <header className="py-4 px-6 md:px-10 flex items-center justify-between border-b bg-white/80 backdrop-blur-sm">
        <div className="flex items-center gap-2">
          <div className="bg-gradient-to-r from-green-500 to-blue-600 w-10 h-10 rounded-lg flex items-center justify-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild size="lg" className="bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-lg px-8 py-6">
                  <Link to="/auth">
                    Start Contributing
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-green-100 to-blue-100 rounded-lg p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="font-semibold">Waste Detection</span>
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-6">
              <div className="relative">
                <div className="w-20 h-20 bg-gradient-to-r from-green-500 to-blue-600 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold">
                  1
                </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-6 md:px-10 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-green-600 text-lg px-8 py-6">
              <Link to="/government">
                View Public Reports
              </Link>
            </Button>
