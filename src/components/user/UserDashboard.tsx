    ...
    <div className="container mx-auto p-4 sm:p-6 space-y-5 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <Badge className="bg-gradient-to-r from-green-500 to-blue-600 text-white border-0 shadow-lg">User Dashboard</Badge>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="border-0 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all bg-gradient-to-br from-green-50 to-blue-50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Uploads</CardTitle>
            <Upload className="h-4 w-4 text-green-600" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-green-700">{recentImages.length}</div>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all bg-gradient-to-br from-blue-50 to-purple-50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all bg-gradient-to-br from-yellow-50 to-orange-50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all bg-gradient-to-br from-purple-50 to-pink-50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Card className="border-0 shadow-sm hover:shadow-md transition-shadow">
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Button size="lg" asChild className="bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all h-12">
              <a href="/upload">
                <Upload className="h-5 w-5 mr-3" />
                Upload New Image
              </a>
            </Button>
            <Button variant="outline" size="lg" asChild className="hover:shadow-lg hover:-translate-y-1 transition-all h-12 border-2 border-green-200 hover:border-green-300">
              <a href="/history">
